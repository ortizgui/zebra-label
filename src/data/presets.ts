...
export const LABEL_PRESETS: LabelPreset[] = [
  ...
  { id: "product-40x25", name: "40 x 25 mm", widthMm: 40, heightMm: 25, dpi: 203, marginMm: 1.5, gapXMm: 3, gapYMm: 3 },
  { id: "product-50x25", name: '50 x 25 mm (2" x 1")', widthMm: 50, heightMm: 25, dpi: 203, marginMm: 2, gapXMm: 3, gapYMm: 3 },
  { id: "product-38x25", name: '38 x 25 mm (1.5" x 1")', widthMm: 38, heightMm: 25, dpi: 203, marginMm: 2, gapXMm: 3, gapYMm: 3 },
  { id: "product-69x49", name: "69 x 49 mm", widthMm: 69, heightMm: 49, dpi: 203, marginMm: 2, gapXMm: 3, gapYMm: 3 },
  ...
  { id: "square-50x50", name: '50 x 50 mm (2" x 2")', widthMm: 50, heightMm: 50, dpi: 203, marginMm: 2, gapXMm: 3, gapYMm: 3 },
  { id: "square-32x32", name: '32 x 32 mm (1.25" x 1.25")', widthMm: 32, heightMm: 32, dpi: 203, marginMm: 2, gapXMm: 3, gapYMm: 3 },
];
